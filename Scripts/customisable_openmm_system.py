...
class CustomisableOpenMMSystem:
    ...
    def remove_force(self):
        ...
        force_string = f'Custom{self.type_of_force_constant}Force'
    ...
    def create_custom_bond_force(self):
        """
        Creates an OpenMM CustomBondForce and adds it to the system.
        :return:
        """
    ...
    def create_custom_angle_force(self):
        """
        Creates an OpenMM CustomAngleForce and adds it to the system. NOTE: Only works for buckyballs.
        :return:
        """
    ...
    def change_force_constants(self, multipliers: list):
        ...
        for multiplier in multipliers:
            ...
            # Create custom force.
            self.create_custom_force()

            # Create OpenMM simulation.
            self.create_and_equilibrate_simulation()

            # Generate output file path.
            outfile_path = f"2_{self.type_of_molecule}_{self.type_of_force_constant}_multiplier_{multiplier}.xml"
...
if __name__ == '__main__':
    ...
    data_from_config_file = read_yaml('example.yaml')
    ...
    for item in data_from_config_file:
        ...
        openmm_system.change_force_constants(multipliers=[0.9, 1.1])
