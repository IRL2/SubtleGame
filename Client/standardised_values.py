...
TASK_TRIALS = 'trials'
TASK_TRIALS_TRAINING = 'trials-training'
...
SHARED_STATE_KEYS_AND_VALS = {
    ...
    KEY_ORDER_OF_TASKS: [TASK_NANOTUBE, TASK_KNOT_TYING, TASK_TRIALS, TASK_TRIALS_TRAINING, TASK_TRIALS_OBSERVER,
                         TASK_TRIALS_OBSERVER_TRAINING],
    KEY_CURRENT_TASK: [TASK_SANDBOX, TASK_NANOTUBE, TASK_KNOT_TYING, TASK_TRIALS, TASK_TRIALS_TRAINING,
